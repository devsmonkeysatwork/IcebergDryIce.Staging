...
{{--                                                @if($order->recurring_payment_status)--}}
                        ...
                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable" bgcolor="#ffffff">
                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    ...
                                    <p style="font-family: Inter;font-weight: 600;font-size: 10px;line-height: 14px;letter-spacing: 0%;color:#1A1C21;">{{ $order->order->customer_name }}</p>
                                    <p style="font-family: Inter;font-weight: 400;font-size: 10px;line-height: 14px;letter-spacing: 0%;color:#5E6470;">{{ $order->order->address }}{{ $order->order->unit ? ', ' . $order->order->unit : '' }}</p>
                                    <p style="font-family: Inter;font-weight: 400;font-size: 10px;line-height: 14px;letter-spacing: 0%;color:#5E6470;">{{ $order->order->city }}, {{ $order->order->country }} - {{ $order->order->postal_code }}</p>
                                    <p style="font-family: Inter;font-weight: 400;font-size: 10px;line-height: 14px;letter-spacing: 0%;color:#5E6470;">{{ $order->order->phone }}</p>
                                </td>
                                <td style="vertical-align: top;">
                ...
                <tr>
                    <td>
                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <!-- Items Loop -->
                            @foreach($order->order->items as $index => $item)
                                <tr>
                            ...
                            <tr>
                                <td><!-- Table Total -->
                                    <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                                        ...
                                        @if($order->order->delivery_cost > 0)
                                            <tr>
                                                <td style="font-family: Inter;font-weight: 700;font-size: 10px;line-height: 18px;letter-spacing: 0%;color: #1A1C21;">
                                                    Delivery Cost
                                                </td>
                                                <td style="font-family: Inter;font-weight: 700;font-size: 10px;line-height: 18px;letter-spacing: 0%;color: #1A1C21;text-align: right;">
                                                    ${{ number_format($order->order->delivery_cost, 2) }}
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-family: Inter;font-weight: 700;font-size: 10px;line-height: 18px;letter-spacing: 0%;color: #1A1C21;text-align: right;">
                                                ${{ number_format($order->order->hazmat, 2) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-family: Inter;font-weight: 700;font-size: 10px;line-height: 18px;letter-spacing: 0%;color: #1A1C21;">
                        ...
                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p style="font-family: Inter;font-size:10px;color:#5685e8;font-weight: 700;line-height: 14px;letter-spacing: 0%;">
                            ...
                            @if($order->order->notes)
                                ...
                                <tr>
                                    <td colspan="2">
                                        <p style="color:#5E6470;font-family: Inter;font-weight: 400;font-size: 10px;line-height: 14px;letter-spacing: 0%;">{{ $order->order->notes }}</p>
                                    </td>
                                </tr>
                            @endif
                            </tbody>
