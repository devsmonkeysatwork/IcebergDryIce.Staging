...
@section('content')
    <div class="row" bp-section="crud-operation-list">
        <div class="col-md-12 pt-4">
            <a href="{{ route('manual-payments.create') }}" class="btn btn-add btn-primary"><i class="la la-plus mx-2"></i> Add Manual Payment</a>
...
{{--                        <td>{{ $payment->recurring_order_id ?? 'N/A' }}</td>--}}
                        ...
                        <td>
                            <a href="{{ route('payments.view', $payment->id) }}" class="btn btn-primary btn-view">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
