                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="btn-group-vertical">
                                <button class="btn btn-secondary email-temp-btn" data-location="Kuehne & Nagel" data-email="vancouver@linde.com" onclick="selectLocation(this)">Kuehne & Nagel</button>
                                <button class="btn btn-secondary email-temp-btn" data-location="Praxair" data-email="admin@icebergdryice.com" onclick="selectLocation(this)">Praxair</button>
                            </div>
                        </div>
                        <div class="col-md-9">
