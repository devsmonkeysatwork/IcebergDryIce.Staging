    ...
    <div class="container">
        ...
        <div class="row my-5">
            <div class="col-12 col-lg-9">
                <form id="payment-form" action="{{ route('manual-payments.initiate') }}" method="POST" class="card p-5">
                    @csrf
                    <div class="row">
                    ...
                    <div class="form-group px-3 d-flex justify-content-between">
                        <div class="mt-2">
                            ...
                            <button type="button" class="btn btn-primary btn-submission" id="other-btn">Others</button>
                        </div>
                    </div>
                </form>
            </div>
...
@push('after_scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Populate form fields when invoice is selected
            ...
            // Other payment methods button handler
